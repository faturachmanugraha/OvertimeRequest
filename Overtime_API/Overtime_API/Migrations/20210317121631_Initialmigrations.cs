        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PositionID = table.Column<int>(type: "int", nullable: false),
                    NIKManager = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    ClientID = table.Column<int>(type: "int", nullable: false),
                    DepartmentID = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TB_M_Employee_TB_M_Employee_NIKManager",
                        column: x => x.NIKManager,
            ...
            migrationBuilder.CreateTable(
                name: "TB_M_Limitation",
                columns: table => new
                {
                    LimitationID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    LimitationName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    LimitationValue = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    OvertimeApplicationID = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TB_M_Limitation", x => x.LimitationID);
                    table.ForeignKey(
                        name: "FK_TB_M_Limitation_TB_T_OvertimeApplication_OvertimeApplicationID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TB_M_Employee_NIKManager",
                table: "TB_M_Employee",
                column: "NIKManager");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TB_M_Limitation_OvertimeApplicationID",
